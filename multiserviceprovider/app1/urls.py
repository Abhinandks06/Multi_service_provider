...
urlpatterns = [
    ...
    path('worker_reg/register/', views.worker_registration, name='worker_registration'),
     ...
     path('providerpage/e_worker/<int:user_id>/', views.activate_worker, name='activate_worker'),
     ...
     path('book-service/<int:userid>/', views.render_booking_form, name='render_booking_form'),
